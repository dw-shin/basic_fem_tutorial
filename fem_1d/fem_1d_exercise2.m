% Exercise 2. Modify fem_for_poisson_1d_ex2.m to solve the Poisson problem with
% non-homogeneous Dirichlet boundary condition,
%
% -u''(x) = f(x) in \Omega \\
% u(x) = u_D(x) on \partial\Omega. \\
%
% After you modify fem\_for\_poisson\_1d_ex2.m, run this code in command window.
% >> fem_1d_exercise2()
%
%
%
...
% rate is k. 
% You can also compare the solution obtained from fem_for_poisson_1d_ex2.m 
...
%     u = fem_for_poisson_1d_ex2(c4n, n4e, n4db, ind4e, M_R, S_R, f, u_D);
