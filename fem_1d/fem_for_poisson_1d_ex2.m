function [u, A, b, freenodes] = fem_for_poisson_1d_ex2(c4n, n4e, ...
    n4db, ind4e, M_R, S_R, f, u_D)
%fem_for_poisson_1d_ex2    FEM solver for Poisson problem in 1D
%   fem_for_poisson_1d_ex2(c4n,n4e,n4db,ind4e,M_R,S_R,f,u_D) solves the
