function [u, A, b, fns] = fem_for_poisson_2d_triangle_ex3_sol(c4n,n4e,n4db, ...
    n4nb,ind4e,M_R,Srr_R,Srs_R,Ssr_R,Sss_R,M_R1D,f,u_D,u_N)
%fem_for_poisson_2d_triangle_ex3_sol    FEM solver for Poisson problem in 2D 
%                                       with triangular elements
%   fem_for_poisson_2d_triangle_ex3_sol(c4n,n4e,n4db,n4nb,ind4e,M_R,Srr_R,Srs_R,
